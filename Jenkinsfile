pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = 'todoapp999'  // Docker image name (can be customized)
        DOCKER_TAG = 'latest'  // Tag for the Docker image
        NEW_DOCKER_TAG = 'us-central1-docker.pkg.dev/my-gke-456113/todoapp9/todoapp999:latest'  // New tag for the Docker image
